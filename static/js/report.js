...
function initBuscaAutores() {
  const inputBusca = document.getElementById("busca-autor");
  const tabela = document.getElementById("tabela-autores-corpo");
  const contador = document.getElementById("contador-autores-visiveis");
